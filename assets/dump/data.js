const events = [
  // model united nations
  {
    ...
    about:
      `Chance to Represent your country at global level`,
    // ----------------------------------------------------------------
    details:`
      <h2>
        Problem Statement
  ...
  // vending masters
  {
    ...
    about:
      `Exhibit you marketing savviness`,
    // ----------------------------------------------------------------
    details:`
      <h2>
        Introduction
  ...
  // trend your brand
  {
    ...
    about:
      "Advertising Ideas~ Endorsing Brands",
    // ----------------------------------------------------------------
    details:
    `<h2>
    Introduction
...
const moreEvents = [
  ...
  rules: [`
    <ul>
      <li>For designing the models, SOLIDWORKS software is mandatory.</li>
      <li> The design must be completed in the given time restriction.</li>
      <li> Submissions should be provided in the appropriate format given by the judges. </li>
      <li> The participants would be required to submit the CAD model in the link provided by 
      the judges in the beginning of the competition.</li>
      <li>Bring your college/student I-Card at the time of competition. </li>
      <li>Decision Taken by Judges will be final and binding for all.</li>
      <li> Any misbehavior will lead you to disqualification from the competition.</li>
      <li> If less than 5 teams will be registered, then only the first prize will be given, and if less 
      than 10 teams will register, only two prizes will be given.</li>
    </ul>
  `],
    faqs: [
      {
  ...
  rules: [`
    <ul>
    <li>Bring your college/student I-Card at the time of the competition.</li>
    <li>Decisions taken by Judges will be final and binding for all. </li>
    <li> Any misbehavior will lead you to disqualification from the competition. </li>
    <li>Organizers have the right to reject entries for any inappropriate team name.  </li>
    <li> Teams who don’t show up on allotted slots will be disqualified.</li>
    <li> lf less then 25 teams have registered for the event only two prizes will be given and if 
    less then 15 teams have registered for the event only two prize will be given.</li>
    </ul>
  `],
    faqs: [
      {
  ...
  // overdrive
  {
    name: "OVERDRIVE",
    image: "/images/events/botmainia.png",
    prize: ["1st Prize: Rs 55,000", "2nd Prize: Rs 40,000","3rd Prize: Rs 25,000"],
    about:
...
track full of various types of obstacles.
  ...
  rules: [`
    <ul>
    <li>Teams are not permitted to damage other team’s car during race intentionally.
    </li>
    <li>Any damage to track due to car will not be tolerated. 
    </li>
    <li> The  car  is  not  allowed  to  lose  any  loose  parts  on  any  part  of  the  arena.  Any  car
    disintegrating during the race will be disqualified. 
     </li>
    <li> Bring your college/student I-Card at the time of competition. 
    </li>
    <li>Decision Taken by Judges will be final and binding for all. </li>
    <li> Any misbehaviour will lead you to disqualification from the competition. </li>
    <li>If less than 5 teams will be registered, then only first prize will be given and if less than 10
    teams will register, only two prizes will be given.
    </li>
    </ul>
  `],
    faqs: [
  ...
  // robowars
  {
    name: "ROBOWARS",
    image: "/images/events/botmainia.png",
    prize: [`<h3>For 15kg Category</h3> <ul> <li>1st prize: Rs. 40,000 </li> <li>2nd Prize: Rs 25,000</li> <li>3rd Prize: Rs. 15,000</li></ul>`, `<h3>For 60kg Category</h3> <ul> <li>1st prize: Rs. 60,000 </li> <li>2nd Prize: Rs 35,000</li> <li>3rd Prize: Rs. 25,000</li></ul>`],
    about:
      "Beat, Defeat, Win, Repeat  ",
    // ----------------------------------------------------------------
    details:
    `<h2>
    Introduction
...
will have two categories: 15 kg and 60 kg.
  ...
  rules: [`
    <ul>
    <li>Any  damage  caused  to  the  arena  at  any  point  of  time  will  lead  to  disqualification
    /penalty.</li>
    <li>A team member can’t be a part of more than one team.    </li>
    <li>Bring your college/student I-Card at the time of competition.     </li>
    <li>Any of the above-mentioned rules, if found violated, teams would not be allowed to
    participate in the competition. </li>
    <li>Decision Taken by Judges will be final and binding for all.</li>
    <li>Any misbehavior will lead you to disqualification from the competition.</li>
    <li>In case of any disputes, the decision of the organizer’s and the jury’s decision will be
    final. </li>
    <li>If less than 5 teams will be registered, then only first prize will be given and if less than
    10 teams will register, only two prizes will be given. 
    </li>
    </ul>
  `],
    faqs: [
  ...
  // maze runner
  {
    ...
    `,
    timeline: [],
    rules: ["Any misbehavior will lead you to disqualification from the competition.", "Decision Taken by Judges will be final and binding for all.", "All decisions taken by the organizing team will be deemed final, and no more changes will be encouraged.", "The idea presented by the teams should be original (not protected by patent/copyright/technical publication by anyone else).", "If less than 5 teams will be registered, then only the first prize will be given and if less than 10 teams will register, only two prizes will be given.", "No one shall enter the arena except the organizers.", "If Any of the above-mentioned rules, if found violated, teams would not be allowed to participate in the competition.", "Any damage caused to the arena at any point in time will lead to disqualification /penalty."],
    faqs: [
      {
        q: "what is this event?",
        a: "vkjdfnv vdfjlvfjvjjlflvldf vnvlndfv kdfv dfmvlkdfmk mvkldfm; dfmblfdm bkldfmb dbkfdmbkbmfdkl fvvkldfmklm fkmdfkfl mkmdfkbkm db mdfdmbkmdfmdf f fdmdkfdmklfdmk m; fdkmmfdkmfdkv fdvmfdv ml;fmvfdm vmfdvmf ",
  ...
  // sky high
  {
    ...
    `,
    timeline: [],
    rules: ["Any misbehavior will lead you to disqualification from the competition.", "Decision Taken by Judges will be final and binding for all", "All decisions taken by the organizing team will be deemed final, and no more changes will be encouraged.", "Plagiarism in any form is strictly prohibited and can even result in the disqualification of contestants involved.", "The idea presented by the teams should be original (not protected by patent/copyright/technical publication by anyone else).", "If less than 5 teams will be registered, then only first prize will be given and if less than 10 teams will register, only two prizes will be given.", "No one shall enter the arena except the organisers.", "Any of the above-mentioned rules, if found violated, teams would not be allowed to participate in the competition.", "Any damage caused to the arena at any point in time will lead to disqualification /penalty."],
    faqs: [
      {
        q: "what is this event?",
        a: "vkjdfnv vdfjlvfjvjjlflvldf vnvlndfv kdfv dfmvlkdfmk mvkldfm; dfmblfdm bkldfmb dbkfdmbkbmfdkl fvvkldfmklm fkmdfkfl mkmdfkbkm db mdfdmbkmdfmdf f fdmdkfdmklfdmk m; fdkmmfdkmfdkv fdvmfdv ml;fmvfdm vmfdvmf ",
  ...
  // cat a pult
  {
    ...
    `,
    timeline: [],
    rules: ["Flammable substances like gunpowder, etc., cannot be used.", "Size of the object to be thrown: Lightweight ball of table-tennis ball’s size", "Maximum range of arena: 40 to 50 meters", "Any misbehavior will lead you to disqualification from the competition.", "Decision Taken by Judges will be final and binding for all.", "All decisions taken by the organizing team will be deemed final, and no more changes", "will be encouraged.", "If Any of the above-mentioned rules, if found violated, teams would not be allowed to", "participate in the competition.", "lf less then 15 teams have registered for the event only two prizes will be given and if less then 10 teams have registered for the event only one prize will be given."],
    faqs: [
      {
        q: "what is this event?",
        a: "vkjdfnv vdfjlvfjvjjlflvldf vnvlndfv kdfv dfmvlkdfmk mvkldfm; dfmblfdm bkldfmb dbkfdmbkbmfdkl fvvkldfmklm fkmdfkfl mkmdfkbkm db mdfdmbkmdfmdf f fdmdkfdmklfdmk m; fdkmmfdkmfdkv fdvmfdv ml;fmvfdm vmfdvmf ",
  ...
  // hunt the line
  {
    ...
    `,
    timeline: [],
    rules: ["Any damage caused to the arena at any point in time will lead to disqualification /penalty.", "The robot has to travel only on the prescribed arena, and if the bot completely leaves the arena it will have to start from the previous checkpoint.", "Bring your college/student I-Card at the time of competition.", "Any of the above-mentioned rules, if found violated, teams would not be allowed to participate in the competition.", "Decision Taken by Judges will be final and binding for all.", "Any misbehaviour will lead you to disqualification from the competition.", "If less than 5 teams will be registered, then only first prize will be given and if less than 10 teams will register, only two prizes will be given. Team Specifications", "Team should be of 3-5 members.", "Members of a team may be from the same college/school or different (K12/UG/PG).", "Any number of teams can participate from one college/school.", "Professionals are not allowed. Only students can participate.", "Participants are required to bring their school/college ID cards.", "Once registered, the same team cannot register with another name or for another robot other than previously registered one.", "Every team must have a unique name that should not be offensive conflicting or inappropriate.", "Organizers have the right to reject entries for any inappropriate team name. Organizers must be notified if a team’s name has been changed.", "Team Representative: Each team must specify their Team Representative (Leader) at the time of registration on the website. All important communications between the organizer and the registered teams will be done through their Team Representative. The Team representatives must submit valid contact details (phone no., email id, etc.) at the time of registration.", "If teams don’t show up on allotted slot, they will be disqualified."],
    faqs: [
      {
        q: "what is this event?",
        a: "vkjdfnv vdfjlvfjvjjlflvldf vnvlndfv kdfv dfmvlkdfmk mvkldfm; dfmblfdm bkldfmb dbkfdmbkbmfdkl fvvkldfmklm fkmdfkfl mkmdfkbkm db mdfdmbkmdfmdf f fdmdkfdmklfdmk m; fdkmmfdkmfdkv fdvmfdv ml;fmvfdm vmfdvmf ",
  ...
  // chem e car
  {
    ...
    about:
      `Voraciously Chem-E-Engineered Car`,
    // ----------------------------------------------------------------
    details:`
      <h2>
        INTRODUCTION
    ...
    `,
    timeline: [],
    rules: ["Bring your college/student I-Card at the time of competition.", "Decision Taken by Judges will be final and binding for all.", "Any misbehavior will lead you to disqualification from the competition.", "If less than 15 teams will be registered, then only first prize will be given and if less than 10 teams will register, only two prizes will be given."],
    faqs: [
      {
        q: "what is this event?",
        a: "vkjdfnv vdfjlvfjvjjlflvldf vnvlndfv kdfv dfmvlkdfmk mvkldfm; dfmblfdm bkldfmb dbkfdmbkbmfdkl fvvkldfmklm fkmdfkfl mkmdfkbkm db mdfdmbkmdfmdf f fdmdkfdmklfdmk m; fdkmmfdkmfdkv fdvmfdv ml;fmvfdm vmfdvmf ",
  ...
  // CODE WARS
  {
    ...
    timeline: [],
    rules: [`<ul>
    <li>The contest will be conducted on CodeForces
    </li>
    <li>Each team will get one computer to submit their solutions to the problem statements(ICPC Style)    </li>
    <li> The team will be rewarded points based on the number of test samples solved.
    </li>
    <li>The team will be ranked as per the number of problem. Statements solved and ties will
    be  broken  by  total  time  taken  by  each  participant/penalty  incurred  on  wrong
    submission.
    </li>
    <li>Plagiarism/Use  of  internet  in  any  form  is  strictly  prohibited  and  can  even  result  in
    disqualification of contestants involved.
    </li>
    <li>All  decisions  taken  by  the  organizing  team  will  be  deemed  as  final,  and  no  more
    changes will been courage.
    </li>
    <li>Any misbehavior will lead you to disqualification from the competition.
    </li>
    <li>If less than 20 teams will be registered, then only two prizes will be given and if less
    than 10 teams will register, only first prize will be given.
    </li>
    </ul>`],
    faqs: [
      {
  ...
  //KRYPTOS
  {
    ...
    <li>Decision Taken by Judges will be final and binding for all
    </li>
    <li>All decisions taken by the organizing team will be deemed final, and no more changes
    will be encouraged. 
    </li>
    <li>Plagiarism in any form is strictly prohibited and can even result in the disqualification
    of contestants involved. 
    </li>
    <li>The idea presented by the teams should be original (not protected by
      patent/copyright/technical publication by anyone else)
      </li>
    <li>If less than 10 teams will be registered, then only first prize will be given and if less
    than 15 teams will register, only two prizes will be given. 
    </li>
    <li>No one shall enter the arena except the organisers.
    </li>
    <li>Any of the above-mentioned rules, if found violated, teams would not be allowed to
    participate in the competition.
    </li>
    <li>Any damage caused to the arena at any point in time will lead to disqualification
    /penalty.
    </li>
    </ul>`],
    faqs: [
  ...
  // BALANCE IT
  {
    ...
    timeline: [],
    rules: [`
    <p>Bot must be autonomous detecting the white and black track. 
    </p>
    <ul>
   <li>Width of bot should be around 60-70 cm (as width of track = 80-90 cm
    </li>
   <li>Weight of bot should be around 5-10 kg
   </li>
   <li>Each team should give certain space to fix the plate of the container.
   </li>
   <li>No further mechanism should be involved to support the container except the 4
   marks.
   </li>
   <li>Only one chance will be given for round 1 
   </li>
   <li>Participants will be given 2 chances even in the case their ball on head falls down
   </li>
   <li>In round 2 the best of two scores will be considered in final judging.
   </li>
   <li> In round 1 if the bot gets out of track then the team has to resume the game from
   that particular point only.
   </li>
   <li> In any condition if the bot moves out of the track then every time the team has to
   resume the game from the check points marked after every stage in round 2
   </li>
   <li>lf less then 15 teams have registered for the event only two prizes will be given and if
   less then 10 teams have registered for the event only two prize will be given.
   </li>
    </ul>`],
    faqs: [
      {
  ...
  //CARRY THE CONSIGNMENT
  {
    ...
    image: "/images/events/botmainia.png",
    prize: ["1st Prize: Rs 21000", "2nd Prize: Rs 17000", "3rd Prize: Rs 13000"],
    about:
      ``,
    // ----------------------------------------------------------------
    details:`
   ...
   <li>If less than 5 teams will be registered, then only the first prize will be given and if less 
   than 10 teams will register, only two prizes will be given.
   </li>
   <li>No one shall enter the arena except the organizers
   </li>
   <li>If Any of the above-mentioned rules, if found violated, teams would not be allowed to 
   participate in the competition.
   </li>
   <li>Any damage caused to the arena at any point in time will lead to disqualification 
   /penalty.
...
// Dr. Driving
{
  ...
  timeline: [],
  rules: [`<ul>
    <li>Vehicle means a four wheeled, electric motor driven RC car.
    </li>
    <li>The RC car must be controllable wirelessly by smartphone.
    </li>
    <li>Maximum RC car dimensions: L=30 cm; B=20 cm; H=20cm
    </li>
    <li>Use appropriate steering and control method.
    </li>
    <li>Participants can use any material for car bodyworks.
    </li>
    <li>Only teams who submit a video showing proof of a working model can proceed to 
    Round 2.
    </li>
    <li>For the Lap Time event, vehicles will have to time 5 laps on the fixed arena.
    </li>
    <li>Any misbehavior will lead you to disqualification from the competition. 
    </li>
    <li>Decision Taken by Judges will be final and binding for all
...
//CHEM-E-JEOPARDY
{
  ...
  timeline: [],
  rules: [`<ul>
  <li>The team should respond to the clue in the question format. For example, the clue is
  “Where is Taj Mahal?”. The answer should not be given Agra directly rather than this it
  should be given in the format “Where is Agra?”
  </li>
  <li>Negative marking for response not submitted in question format along with deduction
  of clue’s value.
  </li>
  <li>After reading the clue, every team will be given 4-5 seconds to buzz the buzzer. No
  team should buzz the buzzer while host was reading the clues and points shall be
  deducted for such conduct. 
  </li>
  <li>It is not allowed to talk among team members after buzzing and scores will be
  deducted for such conduct.
  </li>
  <li>The decision taken by the host would be final. 
  </li>
  <li>Any misbehavior will lead to disqualification from the game.
  </li>
  <li>lf less then 10 teams have registered for the event only two prizes will be given and if
  less then 5  teams have registered for the event only two prize will be given.
  </li>
  </ul>`],
  faqs: [
    {
...
//CONNECTIFY
{
  ...
  timeline: [],
  rules: [`<ul>
    <li>Bring your college/student I-Card at the time of the competition.
    </li>
    <li>Decisions taken by Judges will be final and binding for all.
    </li>
    <li>Any misbehavior will lead you to disqualification from the competition.
    </li>
    <li>Organizershavetherighttorejectentriesforanyinappropriateteamname.
    </li>
    <li>If teams don’t show up on allotted slots, they will be disqualified.
    </li>
    <li>f less then 15 teams have registered for the event only two prizes will be given and if
    less then 10 teams have registered for the event only two prize will be given.
    </li>
  </ul>`],
  faqs: [
...
//TECH CITY
{
  ...
  timeline: [],
  rules: [`<ul>
    <li>Any violation of constraints will result in disqualification of the team.
    </li>
    <li>Decisions Taken by Judges will be final and binding for all.
    </li>
    <li>Any misbehavior will lead you to disqualification from the competition.
    </li>
    <li>Plagiarism is strictly prohibited. Anyone found using the ppts available online or
    copying content from the internet will be immediately disqualified.
    </li>
    <li>If less than 20 teams will be registered, then only two prize will be given and if less
    than 10 teams will register, only one prizes will be given.
    </li>
  </ul>`],
  faqs: [
    {
